...
<body>
    ...
    <!-- Header -->
    <header class="container-fluid bg-secondary fw-bold d-flex justify-content-center align-items-center"
        style="height: 85dvh;">
        <h1 class="text-white">Hello PHP 8.3</h1>
    </header>
    <!-- Main -->
    <main class="container py-4">
        <h4 class="text-center py-4">Lista produselor magazinului nostru</h4>
